...
# Configuration Script – XY-MD02 - Rev. A

This **Configuration** script is designed for the **XY-MD02** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – XY-MD02 Rev. A

Este script de **Configuration** está diseñado para el modelo **XY-MD02** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
